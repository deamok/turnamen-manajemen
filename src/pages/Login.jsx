  ...
  return (
    <div className="page-container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh' }}>
      <div className="card" style={{ maxWidth: '400px', width: '100%', padding: '30px', textAlign: 'center' }}>
        ...
        <h2 style={{ marginBottom: '25px', color: 'var(--color-primary)' }}>Tournament Management</h2>
        
        <p style={{ marginBottom: '30px', color: 'var(--color-text-secondary)' }}>
          Silakan login dan melengkapi data profile untuk mendaftar turnamen atau mengelola jadwal.
        </p>
        ...
        <button 
          ...
          disabled={loading}
          style={{ width: '100%', padding: '12px', fontSize: '1.1rem', display: 'flex', justifyContent: 'center', gap: '10px' }}
        >
